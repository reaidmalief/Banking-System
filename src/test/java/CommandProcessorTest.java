...
public class CommandProcessorTest {
	...
	void open_checking_account() {
		String[] commandArgs = inputParser.parsedCommand("create checking 12345678 0.01");
	...
	void deposit_into_empty_checking_account() {
		...
		String[] commandArgs = inputParser.parsedCommand("deposit 12345678 1000");
		processor.execute(commandArgs);
	...
	void deposit_into_checking_account_twice() {
		bank.openCheckingAccount("12345678", 0.01);
		String[] firstCommandArgs = inputParser.parsedCommand("deposit 12345678 1000");
		processor.execute(firstCommandArgs);
		String[] secondCommandArgs = inputParser.parsedCommand("deposit 12345678 1000");
