public class CheckingAccountCreationValidator implements AccountCreationValidator {
	@Override
	public boolean validate(String command) {
		String[] parts = command.split(" ");
		// Expecting 4 parts: "create", "checking", [accountNumber], [APR]
		if (parts.length != 4) {
			return false;
		}
		...
		if (!operation.equals("create") || !accountType.equals("checking")) {
			return false;
		}
